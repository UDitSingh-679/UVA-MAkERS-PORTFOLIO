...
export default function Collaboration() {
  return (
    <section className="py-20 md:py-32 px-4 md:px-6 relative bg-[#0d0d1a]">
      ...
      <div className="max-w-7xl mx-auto relative z-10 grid grid-cols-1 lg:grid-cols-2 gap-12 lg:gap-16 items-center">
        <div className="relative flex items-center justify-center min-h-[300px] sm:min-h-[400px] md:min-h-[500px] lg:min-h-[600px] lg:-ml-8 xl:-ml-24">
          ...
          <div className="absolute w-48 h-48 sm:w-64 sm:h-64 md:w-80 md:h-80 lg:w-[500px] lg:h-[500px] border-[4px] sm:border-[5px] lg:border-[7px] border-dotted border-[#FFE600]/60 rounded-full drop-shadow-[0_0_10px_rgba(255,230,0,0.3)] overflow-visible" aria-hidden="true" />

          <div className="absolute w-56 h-56 sm:w-72 sm:h-72 md:w-96 md:h-96 lg:w-[620px] lg:h-[620px] border-[4px] sm:border-[5px] lg:border-[7px] border-[#00F5D4]/20 rounded-full overflow-visible" aria-hidden="true">
          ...
          <motion.div animate={{ rotate: 360 }} transition={{ duration: 20, repeat: Infinity, ease: "linear" }} className="absolute w-64 h-64 sm:w-80 sm:h-80 md:w-[500px] md:h-[500px] lg:w-[750px] lg:h-[750px] border-[4px] sm:border-[5px] lg:border-[7px] border-dashed border-[#FF3AF2]/40 rounded-full overflow-visible" style={{ willChange: 'transform' }} aria-hidden="true" />
